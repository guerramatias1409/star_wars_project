...
class SecondScreenDark extends StatefulWidget {
  SecondScreenDark();

  @override
  _SecondScreenDarkState createState() => _SecondScreenDarkState();
}

class _SecondScreenDarkState extends State<SecondScreenDark>
    with SingleTickerProviderStateMixin<SecondScreenDark> {
  Character character;
  Planet planet;
